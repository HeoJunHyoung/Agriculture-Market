...
public class InitDb {
    ...
    static class InitService {
        ...
        public void initSellerDbInit() {
            ...
            Member member = Member.createMember("userB", "1234",address, Role.Seller,phone,"jandai");
            em.persist(member);
        ...
        public void initCustomerDbInit() {
            ...
            Member member = Member.createMember("userA", "1234", address, Role.Customer, phone, "padai");
            em.persist(member);
